...
import {
  Form, Section, Button, Label, VStack,
  RNHostView,
...
export default function ProfileScreen() {
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- initial profile fetch; state updates happen after the async boundary.
    loadProfile();
  }, [loadProfile]);
